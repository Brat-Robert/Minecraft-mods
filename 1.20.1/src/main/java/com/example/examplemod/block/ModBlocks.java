...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> ANCIENTSTONE_BLOCK = registerBlock("ancientstone_block",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).sound(SoundType.AMETHYST)));
    ...
    public static final RegistryObject<Block> SOUND_BLOCK = registerBlock("sound_block",
        ...
        public static final RegistryObject<Block> FIREWORK = registerBlock("firework",
            () -> new FireWorkBlock(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).sound(SoundType.WOOD)));
